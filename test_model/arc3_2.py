...
parser.add_argument('-jn', '--job_number', default=1, type=int,
                    help='test job queue number (default: 1)')
...
if args.device == "cpu":
    # ctdu = TestDatabaseUtil('../log/orderlog/cpu_test_database_after_2020_8_run_by_arc3.xls')
    ctdu = TestDatabaseUtil('../log/arc_test_model_running_effciency_'+ str(args.job_number) +'.xls')
else:
    ctdu = TestDatabaseUtil('../log/orderlog/gpu_test_database_2020_8_14_234025.xls')

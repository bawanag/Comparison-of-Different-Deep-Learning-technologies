...
parser.add_argument('-a', '--architecture', default="vgg11_bn", type=str,
                    help='which VGG archtecture need to be quantized(default:vgg11_bn)')

args = parser.parse_args()

modelname = args.architecture #TODO when the model layers change it need to be changed
